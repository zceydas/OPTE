...
function [A, err, ex] = read_tif_img(fig, res_str, renderer, tmp_nam)
    ...
    try
        ...
        % Print to tiff file
        %% The line below will be  commented out and will use an alternate function to acommodate figure type
        print(fig, renderer, res_str, '-dtiff', tmp_nam);
        %% The line below can be used as backup in versions after R2024b (needs optmizing)
        % exportapp(fig, tmp_nam);
