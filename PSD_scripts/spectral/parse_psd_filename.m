function info = parse_psd_filename(base_name)
...
if isempty(id_match)
    ...
    info.participant = normalize_participant_id(id_match{1});
end
...
elseif contains(name_lower, 'dosing') || contains(name_lower, 'dose') || ...
        contains(name_lower, 'acute') || contains(name_lower, 'ses-2') || ...
        contains(name_lower, 'session2')
    info.session = "dosing";
